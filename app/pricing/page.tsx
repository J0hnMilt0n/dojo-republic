            ...
            return (
              <div
                ...
                className={`bg-white rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition ${
                  index === 1
                    ? "border-2 border-purple-600 transform md:scale-105"
                    : ""
                }`}
              >
                {index === 1 && (
                ...
                <div className="p-8">
                  <div
                    className={`w-16 h-16 ${colors.bg} rounded-lg flex items-center justify-center mb-4 ${colors.icon}`}
                  >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Generate detailed tournament reports and statistics
                  automatically
                </p>
              </div>
            </div>
          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-blue-800 text-sm">
                ...
                credit cards, debit cards, net banking, UPI, and wallets. Your
