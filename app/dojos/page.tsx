...
function DojoCard({ dojo }: { dojo: Dojo }) {
  return (
    <Link href={`/dojos/${dojo.id}`}>
      <div className="group bg-gradient-to-br from-white to-gray-50 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 overflow-hidden cursor-pointer hover:scale-105 border border-gray-100 hover:border-red-200">
