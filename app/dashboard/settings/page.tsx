            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent bg-[#FEFEFE]"
                  placeholder="10"
                  disabled
                  readOnly
                />
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-sm text-gray-500">
                    Receive emails about platform updates and tips
                  </div>
                </div>
                <label className="relative inline-flex items-center cursor-pointer">
