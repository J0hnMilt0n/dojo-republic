...
import { Scale, Copy, Printer } from "lucide-react";
          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div>
              ...
              <p className="text-base text-gray-300 font-light">
                Last updated: <span id="last-updated">April 3, 2026</span>
              </p>
            </div>
          ...
          <div className="prose prose-lg prose-slate max-w-none">
            ...
            <div className="mb-12">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                We are <strong>Dojo Republic</strong> ("Company," "we," "us,"
                "our").
              </p>
              <p className="text-gray-700 leading-relaxed mb-4">
                We operate the Dojo Republic platform, as well as any other
                related products and services that refer or link to these legal
                terms (the "Legal Terms") (collectively, the "Services").
              </p>
              <p className="text-gray-700 leading-relaxed mb-4">
                You can contact us by email at{" "}
                <strong>dojorepublic.official@gmail.com</strong> or by mail to{" "}
                <strong>London, United Kingdom</strong>.
              </p>
              <p className="text-gray-700 leading-relaxed mb-4">
                These Legal Terms constitute a legally binding agreement made
                between you, whether personally or on behalf of an entity
                ("you"), and <strong>Dojo Republic</strong>, concerning your
              ...
              <p className="text-gray-700 leading-relaxed italic text-gray-500">
            ...
            <div id="intellectual-property" className="mb-12 scroll-mt-24">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <strong>dojorepublic.official@gmail.com</strong>. If we ever
            ...
            <div id="user-representations" className="mb-12 scroll-mt-24">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">
                3. USER REPRESENTATIONS
              </h2>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <div id="prohibited-activities" className="mb-12 scroll-mt-24">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">
                4. PROHIBITED ACTIVITIES
              </h2>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            >
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                any Contributions, you thereby represent and warrant that your
                Contributions comply with all provisions of these Legal Terms,
                including but not limited to the representations and warranties
                set forth in the "USER REPRESENTATIONS" section and the
                prohibitions set forth in the "PROHIBITED ACTIVITIES" section.
              </p>
            </div>

            {/* 6. CONTRIBUTION LICENSE */}
            <div id="contribution-license" className="mb-12 scroll-mt-24">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">
                6. CONTRIBUTION LICENSE
              </h2>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <div id="services-management" className="mb-12 scroll-mt-24">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">
                7. SERVICES MANAGEMENT
              </h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div id="term-and-termination" className="mb-12 scroll-mt-24">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">
                8. TERM AND TERMINATION
              </h2>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <div id="governing-law" className="mb-12 scroll-mt-24">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                <strong>Dojo Republic</strong> and yourself irrevocably consent
                that the courts of <strong>England and Wales</strong> shall have
            ...
            <div id="dispute-resolution" className="mb-12 scroll-mt-24">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">
                11. DISPUTE RESOLUTION
              </h2>
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                ...
                informally for at least <strong>30</strong> days before
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                ...
                number of arbitrators shall be <strong>one (1)</strong>. The
                seat, or legal place, of arbitration shall be{" "}
                <strong>London, England</strong>. The language of the
                proceedings shall be <strong>English</strong>. The governing law
            ...
            {/* 12. CORRECTIONS */}
            <div id="corrections" className="mb-12 scroll-mt-24">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">
                12. CORRECTIONS
              </h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div id="limitations-of-liability" className="mb-12 scroll-mt-24">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">
                14. LIMITATIONS OF LIABILITY
              </h2>
              <p className="text-gray-700 leading-relaxed font-semibold mb-4">
                ...
                OF THE AMOUNT PAID, IF ANY, BY YOU TO US OR £100.00 GBP.
              </p>
            </div>
            ...
            <div id="indemnification" className="mb-12 scroll-mt-24">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                harmful act toward any other user of the Services who you
                connected to through the Services. Notwithstanding the
            ...
            {/* 16. USER DATA */}
            <div id="user-data" className="mb-12 scroll-mt-24">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">
                16. USER DATA
              </h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <div id="electronic-communications" className="mb-12 scroll-mt-24">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">
                17. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES
              </h2>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            {/* 18. MISCELLANEOUS */}
            <div id="miscellaneous" className="mb-12 scroll-mt-24">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">
                18. MISCELLANEOUS
              </h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                ...
                permissible by law. We reserve the right to assign any or all of
                our rights and obligations to any other party at any time
                without your consent. These Legal Terms do not create any joint
                venture, partnership, employment, or agency relationship between
                you and us. You agree that these Legal Terms will not be
            ...
            <div id="contact-us" className="mb-12 scroll-mt-24">
              ...
              <ul className="list-none text-gray-700 leading-relaxed space-y-2">
                <li>
                  📧 By email: <strong>dojorepublic.official@gmail.com</strong>
                </li>
                <li>
                  📬 By mail: <strong>London, United Kingdom</strong>
                </li>
              </ul>
            </div>
          </div>
