...
async function seedData() {
  ...
  const users = [
    ...
    {
      id: 'player-4',
      email: 'takeshi@demo.com',
      password: await hashPassword('password123'),
      name: 'Takeshi Yamamoto',
      role: 'player',
      phoneNumber: '+81 (555) 222-0004',
      isApproved: true,
      createdAt: timestamp,
      updatedAt: timestamp,
    },
  ...
  const players = [
    ...
    },
    {
      ...
      gender: 'male',
      beltCategory: 'Black Belt 1st Dan',
      dojoId: 'dojo-2',
      city: 'Los Angeles',
      country: 'USA',
      weight: 75,
    ...
    },
    {
      ...
      gender: 'female',
      beltCategory: 'Black Belt 3rd Dan',
      dojoId: 'dojo-1',
      city: 'Miami',
      country: 'USA',
      weight: 60,
    ...
    },
    {
      ...
      gender: 'female',
      beltCategory: 'Brown Belt 1st Kyu',
      dojoId: 'dojo-2',
      city: 'São Paulo',
      country: 'Brazil',
      weight: 58,
    ...
    },
    {
      ...
      gender: 'male',
      beltCategory: 'Black Belt 4th Dan',
      dojoId: 'dojo-1',
      city: 'Cairo',
      country: 'Egypt',
      weight: 82,
