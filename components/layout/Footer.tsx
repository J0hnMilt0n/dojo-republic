      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="text-gray-300 text-sm leading-relaxed font-light mb-6">
              The Home of Combat Sports. Connecting martial arts communities
              worldwide.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link
                  href="/dojos"
                  className="text-gray-300 hover:text-red-400 transition font-light"
                >
                  Find Dojos
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start space-x-2 text-gray-300">
                ...
                <span className="text-sm font-light">+44 7353872474</span>
              </li>
              <li className="flex items-start space-x-2 text-gray-300">
        ...
        <div className="border-t border-white/10 mt-14 pt-10 text-center">
          <p className="text-gray-400 text-sm font-light">
            &copy; {new Date().getFullYear()} Dojo Republic. All rights
            reserved.
          </p>
          <div className="mt-3 space-x-6">
            <Link
              href="/privacy"
              className="text-gray-400 hover:text-red-400 transition text-sm font-light"
            >
              Privacy Policy
            </Link>
